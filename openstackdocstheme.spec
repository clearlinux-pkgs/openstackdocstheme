...
%prep
%setup -q -n openstackdocstheme-2.2.5
cd %{_builddir}/openstackdocstheme-2.2.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594997227
...
cp %{_builddir}/openstackdocstheme-2.2.5/LICENSE %{buildroot}/usr/share/package-licenses/openstackdocstheme/294b43b2cec9919063be1a3b49e8722648424779
