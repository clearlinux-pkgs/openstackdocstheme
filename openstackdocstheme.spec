...
%prep
%setup -q -n openstackdocstheme-2.0.0
cd %{_builddir}/openstackdocstheme-2.0.0
...
cp %{_builddir}/openstackdocstheme-2.0.0/LICENSE %{buildroot}/usr/share/package-licenses/openstackdocstheme/294b43b2cec9919063be1a3b49e8722648424779
